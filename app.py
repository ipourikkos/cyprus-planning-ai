...
<div class="map-wrap">
      <div id="loadingPanel" class="loading-panel">
        ...
        <div id="loadConstraints" class="load-step">Checking site constraints…</div>
        <div id="loadConfigs" class="load-step">Generating configurations…</div>
      </div>
      <div id="map"></div>
    </div>
</div>
...
function setLoadingStage(stage){
 const ids=["loadParcel","loadPlanning","loadConstraints","loadConfigs"];
...
async function loadConfigurations(){
 ...
 $("configurations").innerHTML='<div class="muted">Generating viable concept configurations…</div>';
 try{
...
async function selectSite(lat,lon){
 ...
 setLoadingStage(3);
 loadConfigurations().finally(()=>hideLoading());
}
map.on("click",e=>{
